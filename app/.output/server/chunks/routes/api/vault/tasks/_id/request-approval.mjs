...
import { b as requestTaskApprovalLifecycle } from '../../../../../_/task-lifecycle.mjs';
import 'node:http';
import 'node:https';
import 'node:events';
import 'node:buffer';
...
const requestApproval = defineEventHandler(async (event) => {
...
export { requestApproval as default };
//# sourceMappingURL=request-approval.mjs.map
