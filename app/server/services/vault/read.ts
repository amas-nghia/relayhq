...
function parseTaskFrontmatter(record: Record<string, unknown>, filePath: string): TaskFrontmatter {
  const frontmatter = {
    ...
    ...(record.dispatch_status === undefined ? {} : { dispatch_status: requireNullableString(record, "dispatch_status", filePath) as TaskFrontmatter["dispatch_status"] }),
    ...(record.dispatch_reason === undefined ? {} : { dispatch_reason: requireNullableString(record, "dispatch_reason", filePath) }),
    ...(record.last_dispatch_attempt_at === undefined ? {} : { last_dispatch_attempt_at: requireNullableTimestamp(record, "last_dispatch_attempt_at", filePath) }),
...
function parseAgentFrontmatter(record: Record<string, unknown>, filePath: string): AgentFrontmatter {
  ...
  const frontmatter = {
    ...
    type: "agent" as const,
    name: requireString(record, "name", filePath),
    ...(record.account_id === undefined ? {} : { account_id: requireNullableString(record, "account_id", filePath) }),
    ...
    ...(record.aliases === undefined ? {} : { aliases: [...requireStringArray(record, "aliases", filePath)].sort(compareText) }),
    ...(record.runtime_kind === undefined ? {} : { runtime_kind: requireString(record, "runtime_kind", filePath) as AgentFrontmatter["runtime_kind"] }),
    ...(record.run_command === undefined ? {} : { run_command: requireString(record, "run_command", filePath) }),
    ...(record.command_template === undefined ? {} : { command_template: requireString(record, "command_template", filePath) }),
    ...(record.run_mode === undefined ? {} : { run_mode: requireString(record, "run_mode", filePath) as AgentFrontmatter["run_mode"] }),
    ...(record.webhook_url === undefined ? {} : { webhook_url: requireString(record, "webhook_url", filePath) }),
    ...(record.working_directory_strategy === undefined ? {} : { working_directory_strategy: requireString(record, "working_directory_strategy", filePath) as AgentFrontmatter["working_directory_strategy"] }),
    ...(record.supports_resume === undefined ? {} : { supports_resume: requireBoolean(record, "supports_resume", filePath) }),
    ...(record.supports_streaming === undefined ? {} : { supports_streaming: requireBoolean(record, "supports_streaming", filePath) }),
    ...(record.bootstrap_strategy === undefined ? {} : { bootstrap_strategy: requireString(record, "bootstrap_strategy", filePath) as AgentFrontmatter["bootstrap_strategy"] }),
    ...(record.verification_status === undefined ? {} : { verification_status: requireString(record, "verification_status", filePath) as AgentFrontmatter["verification_status"] }),
